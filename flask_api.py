"""
Flask API for Heart Risk Assessment - RAG Pipeline Backend
Serves the React frontend with AI-powered risk assessments
"""
...
if not PINECONE_API_KEY or not GROQ_API_KEY:
    raise ValueError("Missing required environment variables: PINECONE_API_KEY and GROQ_API_KEY. Set them in .env file.")
...
# ============================================
def get_risk_level(answer_text):
    """Determine risk level from answer (Low/Medium/High)"""
    lower_text = answer_text.lower()

    # Keywords for each risk level
    high_keywords = ['high risk', 'significant risk', 'severe', 'critical', 'urgent', 'immediate attention', 'concerning', 'dangerous']
    medium_keywords = ['moderate risk', 'some risk', 'elevated', 'caution', 'concerning', 'attention']
    low_keywords = ['low risk', 'minimal risk', 'healthy', 'good', 'maintain', 'positive habits']
...
def extract_recommendations(answer_text):
    ...
    # If no structured recommendations found, extract paragraphs mentioning recommendations
...
def assess_risk():
    ...
    Request body:
    {
        "query": "user's symptoms and habits description"
    }
...
ANSWER:"""
        ...
        risk_level = get_risk_level(response)
